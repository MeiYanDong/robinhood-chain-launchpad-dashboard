...
仓库代码 `0.17.2` 在独立 PAIR V2 与创建者监控之外新增跨代 PAIR Alpha 雷达，并为 PONS / PAIR 加入每日价格历史、七日影子预测与双锚估值：官方目录
...
- PAIR 相对估值：直接展示公式、逐项代入值、来源与共同闭合日窗口，并把现价 PONS 锚、PONS 七日调整锚和 90% / 80% 费用分配假设分开；
