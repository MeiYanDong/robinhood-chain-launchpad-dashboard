    ...
    return {
      ...
      definitions: {
        ...
        pair_relative_valuation:
          "PONS 当前价格 × 有效供应量比 × 最新共同完整 UTC 日的平台成交量比。",
        valuation_range: "最近 7 个共同完整 UTC 日逐日结果的第 25 至第 75 百分位，不是价格承诺。",
      ...
      caveats: [
        ...
        "主参考价至少需要 1 个最新共同完整 UTC 日；缺失日不补 0，PAIR 实际价格不参与参考价。",
        "最近 7 个共同完整 UTC 日仅用于平滑对照和波动区间，不再决定主参考价。",
